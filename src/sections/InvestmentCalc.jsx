  ...
  return (
    <section className="breakable-container break-container">
      <section className="breakable-container break-container lg:px-20 xl:px-24">
        ...
        <div className="breakable-container break-container lg:undo-break-container lg:undo-break-container relative mt-12 bg-darkBlue px-10 py-14 text-white ms:p-16 lg:mt-20 lg:rounded-35 lg:p-14 lg:pb-28">
          <InvestmentCalcForm
