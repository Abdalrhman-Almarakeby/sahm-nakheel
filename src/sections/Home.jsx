...
export default function Home() {
  return (
    <section
      className="flex flex-col-reverse items-center justify-between px-2 pb-2 mt-36 ms:mt-40 lg:mt-0 lg:flex-row lg:gap-4 lg:px-5 lg:pt-16 xl:justify-center 2xl:gap-10"
      id="home"
    >
      <div className="flex flex-col gap-1 p-4 text-center -mt-14 ms:-mt-12 ms:gap-3 sm:gap-5 sm:px-7 md:gap-7 lg:gap-9 lg:pl-6 lg:pr-0 xl:p-10">
        <h3 className="main-p ms:text-sm sm:text-2xl lg:text-xl">
          Start your investment journey with Sahm Nakheel
        </h3>
        <h1 className="text-2xl font-light leading-relaxed ms:text-3xl sm:text-5xl sm:leading-snug lg:text-5xl">
          Affordable investment <br />
          <span className="font-extrabold sm:whitespace-nowrap">
            {" "}
            Starting from
            <span className="font-extrabold whitespace-nowrap text-darkGreen">
              {" "}
              8000 EGP
            </span>
          </span>
        ...
        <div className="flex flex-col gap-2 mt-5 ms:mt-3 ms:flex-row ms:items-center sm:px-4 md:mt-8 lg:flex-row xl:justify-center xl:gap-5">
          <a
            href="#get-started"
            className="font-bold btn whitespace-nowrap ms:grow"
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 border-btn xl group whitespace-nowrap ms:grow lg:gap-4 xl:gap-5"
          ...
          >
            ...
            <svg
              ...
              height="23"
              viewBox="0 0 19 23"
              className="w-3 transition duration-300 fill-darkGreen group-hover:fill-white"
            >
      ...
      <img
        unselectable="on"
        src={shadow2}
        className="absolute hidden pointer-events-none left-7 top-80 -z-40 blur-3xl md:block"
      />
    </section>
  );
}
