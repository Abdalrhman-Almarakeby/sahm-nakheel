...
export default function Home() {
  return (
    <section
      className="mt-36 flex flex-col-reverse items-center justify-between pb-2 ms:mt-40 lg:mt-0 lg:flex-row lg:gap-4 lg:px-5 lg:pt-16 xl:justify-center 2xl:gap-10"
      id="home"
    >
      <div className="-mt-14 flex flex-col gap-1 p-4 text-center ms:-mt-12 ms:gap-3 sm:gap-5 sm:px-7 md:gap-7 lg:gap-9 lg:pl-6 lg:pr-0 xl:p-10">
      ...
      <img
        src={shadow2}
        className="absolute left-7 top-80 -z-40 hidden blur-3xl md:block"
      />
    </section>
  );
}
