    ...
    <>
      <header className="sticky top-0 z-50 flex flex-row items-center justify-between gap-5 px-8 py-4 text-center lg:items-stretch lg:px-6 xl:py-12 lg:justify-start lg:flex-col lg:static lg:py-10 ">
        <img
          ...
          className="self-center max-w-[130px] ms:max-w-[140px] sm:max-w-[150px]"
        />
        <img
          id="icon"
        ...
        >
          ...
          <div className="flex flex-col items-center gap-6 lg:gap-3 lg:flex-row">
            ...
            <a
              className="px-4 py-1 border border-solid rounded-full lg:text-base text-darkBlue border-darkBlue text-md lg:text-darkGreen lg:border-darkGreen xl:text-lg"
              href="#"
            >
              Sign in
            </a>
            <button className="flex items-center gap-3 px-2 lg:px-0 ">
              <svg
                ...
                height="9"
                viewBox="0 0 9 9"
                className="w-5 h-5 fill-darkBlue lg:fill-darkGreen"
              >
