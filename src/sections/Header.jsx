      ...
      >
        ...
        >
          <ul className="flex w-full flex-col gap-2.5 text-sm font-bold ms:gap-5 ms:text-xl md:gap-6 lg:w-auto lg:flex-row lg:gap-4 lg:text-base lg:font-normal xl:text-lg">
            ...
            <span className="w-full h-0.5 bg-gradient lg:hidden" />
            <li>
          ...
          <div className="flex flex-col items-center md:gap-6 lg:flex-row lg:gap-5 xl:gap-6">
            <a
              className="hidden dark-gradient-btn lg:block"
              href="https://play.google.com"
              target="_blank"
            >
              Get app
            </a>
            <a className="hidden bg-transparent border-btn-s lg:block" href="#">
              Sign in
            </a>
            <div className="flex flex-row items-center gap-3.5 ms:mt-10 lg:hidden">
              ...
              <a
                href="#"
                className="px-4 py-1 text-sm border border-solid rounded-full grow border-mintyGray ms:px-8 ms:py-2"
              >
                Log in
              </a>
            </div>
            <p className="pt-3 pb-4 lg:hidden">
              New here ?{" "}
              <a
                href="#"
                className="underline whitespace-nowrap text-lightGreen"
              >
                create an account
              </a>
            </p>
            <div className=" text-mintyGray lg:text-darkGreen">
              <button className="flex items-center gap-1 px-2 py-1 lg:gap-3 lg:px-0">
                ...
                <svg
                  ...
                  height="9"
                  viewBox="0 0 9 9"
                  className="w-5 h-5 fill-mintyGray lg:fill-darkGreen"
                >
