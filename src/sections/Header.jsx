...
export default function Header() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("scroll", function () {
      ...
      if ((scrollDown && scrollAmount > 80) || (scrollUp && scrollAmount > 80))
        setMenuOpen(false);
    ...
    // close the navbar when clicking on any elemnt in it
  }, [menuOpen]);
    ...
    <>
      ...
      >
        ...
        <nav
          id="menu"
          style={navStyle}
          className="-translateZ-px lg:bg-darfrom-darkGreen absolute right-0 z-20 flex w-full flex-col items-center gap-6 bg-darkGreen px-0 py-5 pt-6 text-mintyGray transition-[top] duration-300 md:gap-10 md:pt-20 md:text-lg lg:static lg:flex lg:h-auto lg:w-auto lg:flex-row lg:justify-center lg:gap-8 lg:bg-inherit lg:px-3 lg:pb-0 lg:pt-5 lg:text-base lg:text-darkGreen xl:justify-between xl:px-20 2xl:justify-center 2xl:gap-32"
        >
          <ul className="flex w-full flex-col gap-2.5 text-sm font-bold ms:gap-5 ms:text-xl md:gap-6 lg:w-auto lg:flex-row lg:gap-4 lg:text-base lg:font-normal xl:text-lg">
            ...
            <span className="h-0.5 w-full bg-gradiant lg:hidden" />
            <li>
          ...
          <div className="flex flex-col items-center md:gap-6 lg:flex-row lg:gap-5 xl:gap-6">
            <a
              className="dark-gradiant-btn hidden lg:block"
            ...
            <div className="flex flex-row items-center gap-3 text-mintyGray lg:text-darkGreen">
              ...
              <span className="text-xs lg:hidden">Change Language</span>
            </div>
          </div>
        </nav>
        <img
          src={shadow1}
          className="absolute right-7 top-5 -z-30 rotate-[-15deg] blur-3xl"
        />
      </header>
      <ScrollBtn />
    </>
