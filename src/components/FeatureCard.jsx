export default function FeatureCard({ name, description, src, alt }) {
  return (
    <div className="flex flex-col items-center gap-5 rounded-xl border bg-white px-3 py-8 text-center shadow-features ms:items-start ms:gap-2.5 ms:px-2.5 ms:py-8 sm:px-4 md:gap-3.5 md:px-6 lg:shadow-none xl:p-8">
