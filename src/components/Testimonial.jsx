export default function Testimonial({ img, name, content }) {
  return (
    <div className="flex flex-col gap-1.5 rounded-3xl bg-white px-5 pb-4 pt-3 shadow-testimonials md:p-8 md:px-10 md:py-6 lg:gap-2.5 lg:font-normal lg:shadow-testimonialsLg">
      <img
        src={img}
        alt="User Avatar"
