export default function SectionTitle({ children, description, className }) {
  return (
    <div
      className={`relative flex flex-col items-center gap-2.5 text-center md:font-light md:text-inherit lg:py-20 ${className}`}
    >
      <h3 className="text-fill-transparent lg:text-fill-unset relative bg-gradient-t-b bg-clip-text text-4xl font-bold capitalize ms:text-5xl sm:text-6xl sm:leading-[90px] md:text-7xl lg:bg-none lg:font-light">
        {children}
      </h3>
